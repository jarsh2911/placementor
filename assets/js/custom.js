$(window).on("load", function() {
	...
	$(".close-login-pop-btn,.popup-overlay").on("click", function(){
		$(".jbm-login-popup").removeClass("active");
	});
	...
	$('.close-reg-pop-btn, .popup-overlay').on("click",function(){
	    $(".jbm-can-register-popup").removeClass("active");
	});
	...
	var a = false;
	$('.emp_login').on("click", function(){
	    a=true;
	});
	$('.cand_login').on("click", function(){
	    a=false;
	});
	$('.sel-login').on("click", function(){
	    if(!a)
		location.href="candidate-information.html";
		else
		location.href="employer-information.html";
	});
	// Login form active 
